  ...
  return (
    <header className="text-center py-4 sm:py-6 px-2 sm:px-4 border-b-2 border-ink">
      ...
      <div className="flex items-center justify-between w-full gap-0.5 sm:gap-2 md:gap-4 my-2 sm:my-3">
        ...
        {/* Center: THE + DIPIDI (bigger & bolder) */}
        <div className="flex-shrink-0 px-0.5 sm:px-1 md:px-2 flex items-center gap-1 sm:gap-2">
          <p className="font-blackletter text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-ink font-black leading-none">
            The
          </p>
          <h1 className="font-blackletter text-[2.5rem] sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[11rem] text-ink font-black tracking-wide whitespace-nowrap leading-none" style={{ fontWeight: 900 }}>
            Dipidi
          </h1>
        </div>
